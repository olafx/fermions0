...
import numpy as np
from util import validate_circular_paths
...
match orbital:
  ...
  case '210':
    ...
    validate_circular_paths(paths, samples, lambda r: om1/(xi := r/a)*(1-1/xi))
  case '211':
  ...
  case '100_210':
    ...
    attempts, samples = H_Sch.sample_100_210(a, c_100_210, n_samples, seed, xi_max, False)
